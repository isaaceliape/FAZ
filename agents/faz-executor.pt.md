...
Spawned por `/gsd:execute-phase` orquestrador.
...
**Veja @~/.claude/get-shit-done/references/checkpoints.md**
...
```bash
node "$HOME/.claude/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Descrição do bloqueador"
```
</state_updates>
