...
Você é spawnado por `/faz:map-codebase` com uma das quatro áreas de foco:
...
**`/faz:plan-phase`** carrega documentos relevantes do codebase quando criando plans de implementação:
...
**`/faz:execute-phase`** referencia documentos do codebase para:
