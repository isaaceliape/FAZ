...
<downstream_consumer>
Seu ROTEIRO.md é consumido pelo `/fase-planejar-etapa` que usa para:
...
Template completo: `@./.opencode/templates/roteiro.md`

## Estrutura do ESTADO.md

Use template de `@./.opencode/templates/state.md`.
