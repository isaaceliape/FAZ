...
Registro manual em `./.opencode/settings.json` (Claude Code):

```json
{
  "statusLine": {
    "type": "command",
    "command": "node ./.opencode/hooks/fase-statusline.js"
  },
  "hooks": {
    "PostToolUse": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "node ./.opencode/hooks/fase-context-monitor.js"
          }
        ]
      }
    ]
