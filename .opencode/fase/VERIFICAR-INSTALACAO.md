...
### 3. Workflows FASE
- Diretório `~/.config/opencode/fase`
- Subdiretório `./.opencode/workflows`
...
📁 WORKFLOWS FASE
  <i class="fa fa-check"></i> Diretório ~/.config/opencode/fase: EXISTS
...
═══════════════════════════════════════════════════════════
  ...
  6. Diretório ~/.config/opencode/fase não existe
...
- `bin/comandos/verificar-instalacao.md` - Comando em português
