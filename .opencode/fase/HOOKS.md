...
**Cache**: 5 minutos em `./.opencode/cache/fase-update-check.json`
...
```bash
chmod +x ~/.config/opencode/fase-ai/hooks/*.cjs
```
...
node ~/.config/opencode/fase-ai/hooks/fase-context-monitor.cjs < input.json
```
