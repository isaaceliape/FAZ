...
- <i class="fa fa-check-circle"></i> Cache local em `./.copilot/cache/fase-update-check.json`

### v3.2.0 (Março 2026)

**Path Standardization & Multi-Runtime Architecture**
- <i class="fa fa-check-circle"></i> Todos os comandos e agentes agora usam padrão universal `@./.copilot/`
