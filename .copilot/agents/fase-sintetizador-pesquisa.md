...
- Quais fases provavelmente precisam de `/fase-pesquisar-etapa` durante o planejamento?
...
Use template: @./.copilot/templates/pesquisa-project/SUMARIO.md
...
```bash
node "./.copilot/fase/bin/fase-tools.cjs" commit "docs: complete project pesquisa" --files comandos/pesquisa/
```
