...
Use template: @./.claude/templates/pesquisa-project/SUMARIO.md
...
```bash
node "./.claude/fase/bin/fase-tools.cjs" commit "docs: complete project pesquisa" --files comandos/pesquisa/
```
