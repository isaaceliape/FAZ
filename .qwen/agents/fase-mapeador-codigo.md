...
**`/fase-planejar-etapa`** carrega documentos relevantes do codebase quando criando plans de implementação:
...
**`/fase-executar-etapa`** referencia documentos do codebase para:
