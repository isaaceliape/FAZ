...
Use template: @./.qwen/templates/pesquisa-project/SUMARIO.md
...
```bash
node "./.qwen/fase/bin/fase-tools.cjs" commit "docs: complete project pesquisa" --files comandos/pesquisa/
```
