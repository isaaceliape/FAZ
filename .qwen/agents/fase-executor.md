...
**Validação de schema (schema completo em `./.qwen/fase-shared/references/plano-schema.md`):**
...
**Veja @./.qwen/references/checkpoints.md**
...
**Use template:** @./.qwen/templates/summary.md
