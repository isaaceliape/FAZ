 ...
 * ```
 */
export function readSettings(settingsPath: string): ProviderSettings {
 ...
 */
export function settingsExist(settingsPath: string): boolean {
 ...
 */
export function validateSettings(settingsPath: string): { valid: boolean; error?: string } {
  if (!fs.existsSync(settingsPath)) {
