 ...
 */
export function readTextArgOrFile(
  cwd: string,
 ...
 */
export function buildStateFrontmatter(bodyContent: string, cwd: string | null): ParsedFrontmatter {
 ...
 */
export function syncStateFrontmatter(content: string, cwd: string): string {
