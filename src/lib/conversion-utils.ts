 ...
 */
export function applyToolMapping(content: string, toolMapping: Record<string, string>): string {
 ...
 */
export function applyPathReplacements(content: string, replacements: PathReplacement[]): string {
  let converted = content;
 ...
 */
export function convertSlashCommandsToSkillMentions(content: string): string {
 ...
 */
export function escapeTemplateVariables(content: string): string {
 ...
 */
export function fixTomlEscaping(content: string): string {
  let fixed = content;
 ...
 */
export function parseAllowedTools(frontmatter: string | null): string[] {
