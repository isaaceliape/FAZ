---
title: Visão Geral
description: Bem-vindo ao FASE - Framework de Automação Sem Enrolação
---
...
FASE automatiza tarefas de desenvolvimento, pesquisa, planejamento e execução com agentes de IA paralelos. É construído especificamente para:
...
1. Leia sobre os [Conceitos Fundamentais](/FASE/docs/getting-started/concepts/)
2. Siga o [Quick Start](/FASE/docs/getting-started/quick-start/)
3. Explore a [Documentação Completa](/FASE/docs/)

## Comunidade

- **GitHub:** [isaaceliape/FASE](https://github.com/isaaceliape/FASE)
- **Issues:** [Reportar bugs / sugerir melhorias](https://github.com/isaaceliape/FASE/issues)
