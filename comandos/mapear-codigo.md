...
description: Analisa codebase com agents mapper paralelos para produzir documentos .fase-ai/codigo/
...
Cada agent mapper explora uma área de foco e **escreve documentos diretamente** em `.fase-ai/codigo/`. O orquestrador apenas recebe confirmações, mantendo uso de contexto mínimo.

Output: pasta `.fase-ai/codigo/` com 7 documentos estruturados sobre o estado do codebase.
</objective>
...
Verifique por .fase-ai/ESTADO.md - carrega contexto se projeto já inicializado
...
<process>
1. Verificar se .fase-ai/codigo/ já existe (oferecer refrescar ou pular)
2. Criar estrutura de diretório .fase-ai/codigo/
...
7. Oferecer próximos passos (tipicamente: /fase-novo-projeto ou /fase-planejar-etapa)
</process>

<success_criteria>
- [ ] Diretório .fase-ai/codigo/ criado
