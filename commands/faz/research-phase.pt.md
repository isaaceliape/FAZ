---
name: faz:research-phase
description: Pesquisa como implementar uma fase (standalone - geralmente use /faz:plan-phase ao invés disso)
argument-hint: "[fase]"
allowed-tools:
  - Read
  - Bash
...
**Nota:** Este é um comando de research standalone. Para a maioria dos workflows, use `/faz:plan-phase` que integra research automaticamente.
...
### Próximos Passos
- Para planejamento: `/faz:plan-phase {phase_number}`
...
Após research:
- **Para planejar:** `/faz:plan-phase {phase_number}` (integra RESEARCH.md automaticamente)
- **Para revisar:** User examina RESEARCH.md
- **Para re-research:** Execute `/faz:research-phase {phase_number}` novamente
