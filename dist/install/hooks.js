 ...
 * ```
 */
export function buildHookCommand(configDir, hookName) {
 ...
 */
export function hooksDirExists(configDir) {
 ...
 */
export function readHook(configDir, hookName) {
 ...
 */
export function removeHook(configDir, hookName) {
    const hookPath = path.join(configDir, 'hooks', hookName);
    if (fs.existsSync(hookPath)) {
 ...
 */
export function listHooks(configDir) {
    const hooksDir = path.join(configDir, 'hooks');
    if (!fs.existsSync(hooksDir)) {
        return [];
    }
 ...
 */
export function hookExists(configDir, hookName) {
    const hookPath = path.join(configDir, 'hooks', hookName);
 ...
 */
export function getHookPath(configDir, hookName) {
