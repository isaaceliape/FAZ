 ...
 */
import { extractFrontmatterAndBody, applyPathReplacements, parseAllowedTools, } from '../conversion-utils.js';
/**
 * Tool name mapping from Claude Code to GitHub Copilot
 * GitHub Copilot uses similar tool names to Gemini CLI
 */
const CLAUDE_TO_COPILOT_TOOLS = {
    Read: 'read_file',
    Write: 'write_file',
    Edit: 'replace',
 ...
 */
function applyCopilotContentReplacements(content) {
 ...
 */
function convertCopilotFrontmatter(content) {
